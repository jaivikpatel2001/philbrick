...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    ...
    title: "High tech R&D and manufacturing",
    description:
      "Philbrick is an organization having high-tech equipped R&D manufacturing infrastructure backboned by Highly Qualified Engineers' team, skilled technicians and ERP, serving customers across India.",
    milestone: true,
  },
];
